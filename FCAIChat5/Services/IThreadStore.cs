...
/// <summary>
/// Interface for storing and retrieving AgentThread data
/// </summary>
public interface IThreadStore
{
    /// <summary>
    /// Saves a serialized thread for a specific connection
    /// </summary>
    ...
    /// <summary>
    /// Retrieves a serialized thread for a specific connection
    /// </summary>
    /// <param name="connectionId">The SignalR connection ID</param>
    ...
    /// <summary>
    /// Deletes a stored thread for a specific connection
    /// </summary>
    /// <param name="connectionId">The SignalR connection ID</param>
